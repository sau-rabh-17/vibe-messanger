...
const SideBar = () => {
  ...
  return (
    ...
    text-white ${selectedUser ? 'hidden md:block' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            bg-[#282141] border border-gray-500 text-gray-100 hidden
            group-hover:block'>
        ...
        <div className='bg-[#282141] rounded-full flex items-center gap-2
        py-3 px-4'>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          ...
          cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && `bg-[#282142]/50`}`}>
            ...
            flex justifu-center items-center rounded-full bg-violet-500/50'>
